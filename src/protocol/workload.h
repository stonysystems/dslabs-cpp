...
#define RCC_KISS(row, col, imdt) ((void)0)

#define RCC_PHASE1_RET do { } while (0)

#define RCC_SAVE_ROW(row, index) ((void)0)

#define RCC_LOAD_ROW(row, index) ((void)0)
