...
void RaftServer::SyncRpcExample() {
  ...
  // Example commented out - implement your own RPC calls here
...
bool RaftServer::RequestVote() {
  /* Your code here for leader election */
  return false;
}
...
void RaftServer::OnRequestVote(const slotid_t& lst_log_idx,
  ...
  /* Your code here for handling RequestVote RPC */
  *reply_term = 0;
  *vote_granted = false;
  cb();
}
...
void RaftServer::OnAppendEntries(const slotid_t slot_id,
                                 ...
                                 const function<void()> &cb) {
  /* Your code here for handling AppendEntries RPC */
  *followerAppendOK = 0;
